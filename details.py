...
class Details:
    def __init__(self):
        ...
        st.text("5.) The output column should be the last column in the dataset file which you are\nuploading.")
        st.text("6.) The columns names in the dataset should be UpperCase only for Snowflake\nDatabase query execution.")
